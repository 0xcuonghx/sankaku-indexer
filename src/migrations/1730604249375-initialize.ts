...
export class Initialize1730604249375 implements MigrationInterface {
    name = 'Initialize1730604249375'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_reason_enum" AS ENUM('insufficient-funds', 'unsubscribed')`);
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_type_enum" AS ENUM('plus', 'infinite')`);
        await queryRunner.query(`CREATE TABLE "subscriptions" ("account" character varying NOT NULL, "planId" integer NOT NULL, "last_execution_timestamp" integer NOT NULL, "next_execution_timestamp" integer NOT NULL, "basis" "public"."subscriptions_basis_enum" NOT NULL DEFAULT 'weekly', "receiver" character varying NOT NULL, "token" character varying NOT NULL, "amount" character varying NOT NULL, "status" "public"."subscriptions_status_enum" NOT NULL DEFAULT 'active', "reason" "public"."subscriptions_reason_enum", "type" "public"."subscriptions_type_enum" NOT NULL, CONSTRAINT "PK_1cbc78eebc11622c56e6b879455" PRIMARY KEY ("account"))`);
        await queryRunner.query(`CREATE TABLE "smart-accounts" ("owner" character varying NOT NULL, "account" character varying NOT NULL, "salt" character varying NOT NULL, CONSTRAINT "PK_f5cee5f76035a1fed59fd9aed89" PRIMARY KEY ("owner", "account"))`);
        ...
        await queryRunner.query(`CREATE TABLE "last_sync_block" ("id" integer NOT NULL DEFAULT '1', "last_synced_block" integer NOT NULL, CONSTRAINT "PK_814df3d8c14ada369072a9e2b9d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."activity_logs_type_enum" AS ENUM('wallet_created', 'token_transferred', 'token_received', 'recurring_execution_installed', 'recurring_execution_uninstalled', 'recurring_execution_executed')`);
        await queryRunner.query(`CREATE TABLE "activity_logs" ("id" SERIAL NOT NULL, "account" character varying NOT NULL, "type" "public"."activity_logs_type_enum" NOT NULL, "timestamp" integer NOT NULL, "data" json, CONSTRAINT "PK_f25287b6140c5ba18d38776a796" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "last_sync_block"`);
        await queryRunner.query(`DROP TABLE "blocks"`);
        await queryRunner.query(`DROP TABLE "smart-accounts"`);
        await queryRunner.query(`DROP TABLE "subscriptions"`);
        await queryRunner.query(`DROP TYPE "public"."subscriptions_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."subscriptions_reason_enum"`);
