...
export class Initialize1730390818507 implements MigrationInterface {
    name = 'Initialize1730390818507'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscriptions" ("account" character varying NOT NULL, "planId" integer NOT NULL, "last_execution_timestamp" integer NOT NULL, "next_execution_timestamp" integer NOT NULL, "basis" "public"."subscriptions_basis_enum" NOT NULL DEFAULT 'weekly', "receiver" character varying NOT NULL, "token" character varying NOT NULL, "amount" character varying NOT NULL, "status" "public"."subscriptions_status_enum" NOT NULL DEFAULT 'active', "reason" "public"."subscriptions_reason_enum", CONSTRAINT "PK_1cbc78eebc11622c56e6b879455" PRIMARY KEY ("account"))`);
